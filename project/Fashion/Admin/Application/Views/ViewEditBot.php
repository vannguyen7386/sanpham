<div>
<form name="FormEdit" action="Application/Controllers/UpdateBot.php" method="post">
    <p>Navi Name: <input type="text" value="<?php echo $row['FieldName']?>" name="Name" class="Text" /><input type="hidden" name="Id" value="<?php echo $row['ID'] ?>" /></p>    
