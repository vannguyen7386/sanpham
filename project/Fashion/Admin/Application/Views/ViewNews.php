<script language="javascript">
    function submitFormDel(){
        if(confirm('Bạn có muốn xóa các tin tức này')){
            document.FormDel.submit();
        }    
    }   
   
</script>         
                <form name="FormDel" action="Application/Controllers/DelNews.php" method="post">
                    ...
                    <tr class="second">
                        ...
                        <td valign="middle"><a href="EditNews.php?Id=<?php echo $row['InfoID']?>" class="red" style="margin-left: 5px;"><b><?php echo $row['InfoHead']?></b></a></td>
                        <td valign="middle"><a href="EditNews.php?Id=<?php echo $row['InfoID']?>" style="margin-left: 5px;" class="black"><?php echo $Summary?></a></td>
                        ...
                        <td valign="middle" align="center"><a href="EditNews.php?Id=<?php echo $row['InfoID']?>"><img src="../<?php echo $row['InfoImage'] ?>" width="140" /></a></td>
                        <td valign="middle" align="center"><a href="Application/Controllers/DelNews.php?Id=<?php echo $row['InfoID']?>" onclick="return confirm('Bạn có chắc muốn xóa bản tin này')"><img src="../Image/DeleteRed.png" /></a></td>
                ...
                <div class="Add_Del"><a href="AddNews.php" class="Add">Thêm bản tin</a><a href="javaScript:submitFormDel()" class="Delete" >Xóa bản tin</a></div>
